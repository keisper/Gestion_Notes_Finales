...
import static ar.com.fdvs.dj.domain.constants.Page.Page_A4_Landscape;
    ...
    public void printDynamicReport(
        ...
        try {
            ...
            drb.setTitle(titre)
                    ...
                    .addFirstPageImageBanner(new File("images/logo_isj.jpeg").getPath(), 100, 100, ImageBanner.Alignment.Center);
    ...
    public void printDynamicReport(
        ...
        try {
            ...
            drb.setTitle(titre)
                    ...
                    .addFirstPageImageBanner(getClass().getClassLoader().getResource("images/logo_isj.jpeg").getPath(), 200, 138, ImageBanner.Alignment.Center);    //définit l'image qui sera afficher au dessus du rapport
