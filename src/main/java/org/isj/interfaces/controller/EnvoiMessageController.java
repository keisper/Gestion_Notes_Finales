...
public class EnvoiMessageController implements Initializable {
    ...
    @FXML
    private TableColumn<EnvoiMessage, String> candidatColumn;
    ...
    public void listEnvoiMessage() throws SQLException {
        ...
        if (Connexion.peutLire(EnvoiMessage.class)) {
            ...
            candidatColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getCandidat().getNom()));
            messageColumn.setCellValueFactory(cellData -> new SimpleObjectProperty(cellData.getValue().getMessage().getContenu()));
            ...
            ResultSetMetaData resultSetMetaData = new Isj().renvoyerChamp("envoi_message");
