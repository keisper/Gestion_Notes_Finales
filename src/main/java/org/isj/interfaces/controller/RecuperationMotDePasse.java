...
public class RecuperationMotDePasse implements Initializable {
    ...
    public void handleOkRecuperation() {
        try{
            if(sms.isSelected()) {
                ...
                loader.setLocation(getClass().getClassLoader().getResource("view/recuperationMotDePasseSMS.fxml"));
                ...
                FXMLLoader loader = new FXMLLoader();
                loader.setLocation(getClass().getClassLoader().getResource("view/recuperationMotDePasseEmail.fxml"));
                AnchorPane page = loader.load();
                Stage dialogStage = new Stage();
    ...
    public void handleOkRecuperationSMS(){
        try{
            ...
            if (isInputValid.equalsIgnoreCase("")) {
                ...
                FXMLLoader loader = new FXMLLoader();
                loader.setLocation(getClass().getClassLoader().getResource("view/recuperationMotDePasseCodeSms.fxml"));
                AnchorPane page = loader.load();
                Stage dialogStage = new Stage();
    ...
    public void handleOkRecuperationEmail() {
        try{
            ...
            if (isInputValid.equalsIgnoreCase("")) {
                ...
                FXMLLoader loader = new FXMLLoader();
                loader.setLocation(getClass().getClassLoader().getResource("view/recuperationMotDePasseCodeEmail.fxml"));
                AnchorPane page = loader.load();
                Stage dialogStage = new Stage();
                dialogStage.setTitle("Code de récupération");
                Scene scene = new Scene(page);
    ...
    public void handleCodeEmail()throws Exception{
        ...
        if (isInputValid.equalsIgnoreCase("")) {
            ...
            System.out.println(code);
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getClassLoader().getResource("view/recuperationMotDePasseConfirmation.fxml"));
            AnchorPane page = loader.load();
            Stage dialogStage = new Stage();
            dialogStage.setTitle("Code de récupération");
            Scene scene = new Scene(page);
