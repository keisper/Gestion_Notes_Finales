...
public class DisciplineController implements Initializable {
    ...
    public void handleCharger() throws Exception {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getClassLoader().getResource("view/EmplacementDiscipline.fxml"));
    ...
    @FXML
    public void handleProduire() throws Exception{
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getClassLoader().getResource("view/ChoixFiche.fxml"));
        BorderPane page = loader.load();
        Stage dialogStage = new Stage();
        dialogStage.getIcons().add(new Image("images/logo_isj.jpeg"));
        Scene scene = new Scene(page);
