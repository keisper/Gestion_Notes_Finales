...
public class ChoixPvController implements Initializable {
    ...
    public void handleOK() {
        ...
        Task<Void> task = new Task<Void>() {
            ...
            public Void call() throws Exception {
                ...
                new GeneratePDF().genererPv(niv, fil, ann, sem);
        ...
        task.setOnSucceeded(e -> {
            ...
            alert.setTitle("ISJ");
            alert.setContentText("PV produit avec succes !");
            alert.show();
        });
        task.setOnFailed(e -> {
            ...
            alert.initOwner(Appli.getPrimaryStage);
            alert.setTitle("ISJ");
            alert.setContentText("PV échoué !");
            alert.show();
        });
