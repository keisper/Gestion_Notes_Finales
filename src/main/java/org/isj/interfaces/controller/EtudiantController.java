...
public class EtudiantController implements Initializable {
    ...
    public void handleEnregistrer() {
        ...
        if (Connexion.peutLire(Etudiant.class) || Connexion.peutModifier(Etudiant.class)) {
            try {
                ...
                //java.lang.ClassCastException: java.lang.String cannot be cast to org.isj.metier.entites.Classe
                /**
    ...
    public void handleReleve() throws Exception{
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getClassLoader().getResource("view/ChoixReleve.fxml"));
        BorderPane page = loader.load();
        Stage dialogStage = new Stage();
        Scene scene = new Scene(page);
        dialogStage.setScene(scene);
    ...
    public void handleCharger(){
        ...
        alert.initOwner(Appli.getPrimaryStage);
        alert.setTitle("ISJ");
        alert.setContentText("Veuillez le faire à partir de l'interface de candidats !");
        alert.show();
        return;
