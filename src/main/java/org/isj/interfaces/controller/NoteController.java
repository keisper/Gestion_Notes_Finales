...
public class NoteController implements Initializable {
            ...
            try {
                ...
                if (noteSelectionne != null) {
                    ...
                    if (result.get() == ButtonType.OK) {
                        noteSelectionne.setStatutVie(Note.StatutVie.CLOTUREE);
                        String suppression = noteFacade.merge(noteSelectionne);// noteFacade.remove(noteSelectionne);
    ...
    public void handleChargerNote(ActionEvent event) throws Exception{
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getClassLoader().getResource("view/ChoixNote.fxml"));
        AnchorPane page = loader.load();
        Scene scene = new Scene(page);
        stage.getIcons().add(new Image("images/logo_isj.jpeg"));
