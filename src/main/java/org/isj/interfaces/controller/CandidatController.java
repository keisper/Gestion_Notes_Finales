...
public class CandidatController implements Initializable {
    ...
    public void handleenvoyer() {
        ...
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getClassLoader().getResource("view/Typemessage.fxml"));
    ...
    public void handleCharger(){
        try{
            ...
            if (file != null) {
                ...
                Stage stage=Appli.getPrimaryStage();
                String oldTitre=stage.getTitle();
                Scene oldScene=stage.getScene();
                stage.setTitle("Importation des candidats en cours...");
                stage.setScene(scene);
                stage.show();

                new Isj().importerCandidat(file.getAbsolutePath());

                stage.setScene(oldScene);
                stage.setTitle(oldTitre);
                stage.show();
    ...
    public void handleProprietes() throws Exception{
        ...
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getClassLoader().getResource("view/Connexion.fxml"));
