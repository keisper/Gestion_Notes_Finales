        ...
        if (Connexion.peutLire(Enseignant.class) || Connexion.peutModifier(Enseignant.class)) {
            try {
              ...
              //  Enseignement enseignementEnseignant = enseignement.getSelectionModel().getSelectedItem();
                ...
                String resultat;
                if (enseignantSelectionne == null) {
                    resultat = enseignantFacade.enregistrer("", "", nomEnseignant, prenomEnseignant, emailEnseignant, Integer.parseInt(telephoneEnseignant), dateNaissance, sexe, Personne.Statut.ACTIVE, qualificationEnseignant);
                }else {
